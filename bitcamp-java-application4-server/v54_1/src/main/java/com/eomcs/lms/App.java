...
public class App implements HttpRequestHandler {
  ...
  public void handle(HttpRequest request, HttpResponse response, HttpContext context)
    ...
    // 클라이언트가 요청한 명령 알아내기
    // [request line]
    // => GET /member/add?name=aaa&email=aaa@test.com&password=111&tel=1111-1111
    // [uri]
    // => /member/add?name=aaa&email=aaa@test.com&password=111&tel=1111-1111
    ...
    try {
      ...
      if (requestHandler != null) {
        ...
        StringEntity entity =
            new StringEntity("<html><body><h1>해당 명령을 찾을 수 없습니다!</h1></body></html>",
                ContentType.create("text/html", "UTF-8"));
        response.setEntity(entity);
        logger.info("실패");
      }
      ...
      response.setStatusCode(HttpStatus.SC_OK);
      StringEntity entity = new StringEntity("<html><body><h1>해당 명령을 찾을 수 없습니다!</h1></body></html>",
          ContentType.create("text/html", "UTF-8"));
      response.setEntity(entity);
    }
  }
