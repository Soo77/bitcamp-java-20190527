...
//  private static final Logger logger = LogManager.getLogger(PhotoBoardCommand.class);
  ...
  public void form(ServletRequest request, ServletResponse response) {
    ...
    out.println("수업: <input type='text' name='photoBoardNo'><br>");
  ...
  public void add(ServletRequest request, ServletResponse response) {
    ...
    try {
      ...
      photoBoard.setLessonNo(Integer.parseInt(request.getParameter("photoBoardNo")));
  ...
  public void list(ServletRequest request, ServletResponse response) {
    ...
    out.println("<a href='/photoboard/form'>새 수업</a><br>");
    try {
      ...
      for (PhotoBoard photoBoard : photoBoards) {
        out.printf("<tr><th>%d</th>" 
                  + "<th><a href='/photoboard/detail?no=%d'>%s</a></th>" + "<th>%s</th>"
                  + "<th>%d</th>" + "<th>%d</th>" + "</tr>\n",
            photoBoard.getNo(), photoBoard.getNo(), photoBoard.getTitle(), photoBoard.getCreatedDate(),
