// v34_1: >_< 클라이언트 요청을 처리하는 부분을 별도의 스레드(실)로 분리하여 실행한다.
...
//      LessonServlet lessonServlet = (LessonServlet)servletContext.get("/lesson/");
      ...
      while (true) {
        ...
        // => RequestHandler는 별도의 실행흐름으로 분리될 수 있는 Thread이다.
        ...
        */
        ...
        // 클라이언트 중에 하나가 서버 종료를 설정했다면 현재 접속한 클라이언트 요청까지만 처리하고 서버 실행을 멈춘다. 
        // 주의!
