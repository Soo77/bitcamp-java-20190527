// hash code 응용 II - Wrapper 클래스를 key 객체로 사용하기
package ch15;
...
public class Test10_1 {
  public static void main(String[] args) {
    ...
    // 인스턴스 필드의 값이 같은지 따지지 않고 무조건 인스턴스 마다 고유의 해시 값을 리턴한다.
    // 또한 equals()는 인스턴스 필드의 값이 같은지 비교하지 않고 같은 인스턴스인지만 따진다.
    // 
    // 그러나 Integer 클래스 등의 Wrapper 클래스와 String 클래스는
    // Object 클래스에서 상속 받는 hashCode()와 equals()를 오버라이딩 했기 때문에
