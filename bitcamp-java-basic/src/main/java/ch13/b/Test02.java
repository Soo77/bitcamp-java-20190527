...
public class Test02 {
  public static void main(String[] args) {
    ...
    s2.setName("임꺽정"); 
    s2.setMusic(100); // Score2의 compute2() 호출 => 5과목의 합계와 평균계산
    s2.setArt(100); // Score2의 compute2() 호출 => 5과목의 합계와 평균계산
    s2.setKor(100); // Score의 compute() 호출 => 3과목의 합계와 평균계산
    s2.setEng(100); // Score의 compute() 호출 => 3과목의 합계와 평균계산
    s2.setMath(100); // Score의 compute() 호출 => 3과목의 합계와 평균계산
